...
const Footer = () => {
  return (
    <div>
      <footer class=" mx-auto sm:px-6 lg:px-36 mt-28 bg-[#119744] sm:p-6 ">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
            <a href="https://flowbite.com" class="flex items-center">
              <img
                src="https://freedesignfile.com/upload/2017/03/Fresh-vegetables-logo-design-vector-06.jpg"
                class="mr-3 h-8"
                alt="FlowBite Logo"
              />
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
              <h2 class="mb-6 text-sm font-semibold text-black">Follow us</h2>
              <ul class="text-black">
                <li class="mb-4">
                  <a
